...
from .policy import best_effort_close_async, new_wait_histogram, record_wait
...
class AsyncConnectionPool:
    ...
    async def close_all(self) -> None:
        ...
        for conn in conns:
            await best_effort_close_async(conn, logger=logger, context="pool shutdown")
